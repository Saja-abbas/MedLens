...
import 'package:medlens/systle/color.dart';
import 'package:medlens/systle/image.dart';
// import '';
          ...
          Padding(
            ...
            child: PrimaryButton(
              ...
              onTap: () {
                ...
                {
                  // print("");
                  Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (dynamic context)=>mainpage_patient(), ),
                  (dynamic route)=>false,);
...
List<OnBoarding> onBoardinglist = [
  ...
  OnBoarding(
      ...
      description:
          'Advanced scanning technology to analyze medical lab reports. Accurate and user-friendly graphical representations of data.Identification of fluctuations in substances to diagnose illnesses'),
  OnBoarding(
      title: "Illness Diagnosis and Symptom Analysis",
      image: ImagesPath.kOnboarding3,
      description:
          'Early diagnosis of illnesses through symptom analysis. Identification of potential. Insights into disease health risks and complications progression and management'),
];