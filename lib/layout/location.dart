...
import 'package:medlens/layout/webviewtest.dart';
...
class _view_mapState extends State<view_map> {
  ...
  void List_function() async {
    var url = Uri.parse(login.url+"doctor/track/");
                        ...
                        new Padding(
                          ...
                          child: new Column(
                            ...
                            children: <Widget>[
                              ...
                              new Text(('Doctor:' )+" "+data[index]['doctor_name'].toString(), style: Theme
                                  .of(context)
                                  .textTheme
                                  .titleMedium
                              ),
                              Container(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: (){
                                    ...
                                    webviewtest.aid=data[index]['doctor_id'].toString();
