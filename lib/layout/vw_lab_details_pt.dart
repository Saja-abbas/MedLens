...
class vw_lab_details_pt extends StatefulWidget {
  const vw_lab_details_pt({Key? key}) : super(key: key);

  @override
  State<vw_lab_details_pt> createState() => _vw_lab_details_ptState();
}

class _vw_lab_details_ptState extends State<vw_lab_details_pt> {
  late List data;
  void List_function() async {
    var url = Uri.parse(login.url+"/lab/get_labb/");
